...
#server - crawler
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/login/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/sj_crawling/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/etc/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/list/')
sys.path.insert(0,'/home/iml/SIGNUS_Crawler/src/dbs/mongo/')